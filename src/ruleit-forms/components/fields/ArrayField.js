...
import IconArrowUp from "mdi-material-ui/ArrowUpBold";
import IconArrowDown from "mdi-material-ui/ArrowDownBold";
...
function DefaultArrayItem(props) {
  return (
    <Grid container key={props.index} className={props.className}>
      <Grid item xs={props.hasToolbar ? 9 : 12}>
        {props.children}
      </Grid>

      {props.hasToolbar && (
        <Grid item className="array-item-toolbox" xs={3}>
          <div
            style={{
              display: "flex",
